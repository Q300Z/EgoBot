...
export type SupplierCreateWithoutCurrentAddressInput = {
  id?: string
  supplierCode: string
  name: string
  contactEmail?: string | null
...
export type SupplierUncheckedCreateWithoutCurrentAddressInput = {
  id?: string
  supplierCode: string
  name: string
  contactEmail?: string | null
...
export type SupplierCreateOrConnectWithoutCurrentAddressInput = {
...
export type SupplierSelect<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetSelect<{
  ...
  createdAt?: boolean
  updatedAt?: boolean
  currentAddress?: boolean | Prisma.Supplier$currentAddressArgs<ExtArgs>
...
export type SupplierOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "supplierCode" | "name" | "contactEmail" | "phone" | "currentAddressId" | "isActive" | "createdAt" | "updatedAt", ExtArgs["result"]["supplier"]>
...
export interface Prisma__SupplierClient<T, Null = never, ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
  ...
  currentAddress<T extends Prisma.Supplier$currentAddressArgs<ExtArgs> = {}>(args?: Prisma.Subset<T, Prisma.Supplier$currentAddressArgs<ExtArgs>>): Prisma.Prisma__AddressClient<runtime.Types.Result.GetResult<Prisma.$AddressPayload<ExtArgs>, T, "findUniqueOrThrow", GlobalOmitOptions> | null, null, ExtArgs, GlobalOmitOptions>
...
export interface SupplierFieldRefs {
  ...
  readonly currentAddressId: Prisma.FieldRef<"Supplier", 'String'>
...
/**
 * Supplier.currentAddress
 */
export type Supplier$currentAddressArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
